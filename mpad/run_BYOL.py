...
def main():
    ...
    sim = BYOL(backbone=model, project_dim=args.hidden, bottle_neck_dim=args.bottleneck)
    ...
    for epoch in range(1, args.epochs):
        ...
        for i in range(n_train_batches):
            ...
            with torch.no_grad():
                ...
                _, b2 = sim.encoder[0](
                    features_train_2[i], adj_train_2[i], batch_n_graphs_train_1[i]
                )
