...
def run_unsupervised(
    ...
    try:
        with tqdm.tqdm(
            ...
            for i in range(args.epochs):
                ...
                torch.save(
                    ckpt,
                    "CKPTS_SIMCLR/{model_id}_{aug_type}_{aug_ratio}_epoch_{e}.pth".format(
                        model_id=model_id,
                ...
                if knn_acc > best_epoch:
                    ...
                    torch.save(
                        best_ckpt,
                        "CKPTS_SIMCLR/best_{model_id}_{aug_type}_{aug_ratio}.pth".format(
                            model_id=model_id,
                            aug_type=args.aug_type,
                            aug_ratio=args.aug_ratio,
                        ),
        ...
        torch.save(
            final_ckpt,
            "CKPTS_SIMCLR/resume_{model_id}_{aug_type}_{aug_ratio}.pth".format(
    ...
    torch.save(
        final_ckpt,
        "CKPTS_SIMCLR/final_{model_id}_{aug_type}_{aug_ratio}.pth".format(
            model_id=model_id, aug_type=args.aug_type, aug_ratio=args.aug_ratio
        ),
    )
