...
import tqdm
from models import MNIST_GNN, SimSiam
...
def run_unsupervised(
    ...
    try:
            ...
            for i in range(args.epochs):
                ...
                for data in train_loader:
                    ...
                    with torch.no_grad():
                        ...
                        b1 = model.encoder[0](view_1.x, view_1.edge_index, view_1.batch)
                        b2 = model.encoder[0](view_2.x, view_2.edge_index, view_2.batch)

                        p1 = model.encoder(view_1.x, view_1.edge_index, view_1.batch)
                        p2 = model.encoder(view_2.x, view_2.edge_index, view_2.batch)
                ...
                torch.save(
                    ckpt,
                    "CKPTS/{model_id}_{aug_type}_{aug_ratio}_epoch_{e}.pth".format(
                        model_id=model_id,
        ...
        torch.save(
            final_ckpt,
            "CKPTS/resume_{model_id}_{aug_type}_{aug_ratio}.pth".format(
    ...
    torch.save(
        final_ckpt,
        "CKPTS/final_{model_id}_{aug_type}_{aug_ratio}.pth".format(
            model_id=model_id, aug_type=args.aug_type, aug_ratio=args.aug_ratio
        ),
    )
